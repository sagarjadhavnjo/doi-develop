...
/**
 * The Class EDPUserRoleMappingDto.
 * 
 * @version 1.0
 * @created 2019/12/30 11:27:53
 *
 */
public class EDPUserRoleMappingDto extends BaseDto implements Serializable {
	...
	/**
	 * Instantiates a new EDP user role mapping dto.
	 */
	public EDPUserRoleMappingDto() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EDPUserRoleMappingDto other = (EDPUserRoleMappingDto) obj;
		return employeeId == other.employeeId && postOfficeUserId == other.postOfficeUserId && remark == other.remark
				&& submissionStatus == other.submissionStatus && Objects.equals(transactionNumber, other.transactionNumber)
				&& userRoleMappingId == other.userRoleMappingId;
	}
