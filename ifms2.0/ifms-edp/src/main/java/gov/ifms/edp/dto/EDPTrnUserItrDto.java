...
/**
 * The Class EDPTrnUserItrDto.
 */
public class EDPTrnUserItrDto extends BaseDto implements Serializable {
	...
	/**
	 * Instantiates a new EDP trn user itr dto.
	 */
	public EDPTrnUserItrDto() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof EDPTrnUserItrDto)) {
			return false;
		}
		EDPTrnUserItrDto other = (EDPTrnUserItrDto) obj;
		return alwaysLogin == other.alwaysLogin && firstLogin == other.firstLogin && invalidLoginCnt == other.invalidLoginCnt
				...
				&& userId == other.userId && userItrId == other.userItrId && Objects.equals(userName, other.userName)
