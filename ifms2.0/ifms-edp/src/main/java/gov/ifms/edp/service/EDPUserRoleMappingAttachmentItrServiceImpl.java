...
/**
 * The Class EDPUserRoleMappingAttachmentItrServiceImpl.
 */
@Service
public class EDPUserRoleMappingAttachmentItrServiceImpl implements EDPUserRoleMappingAttachmentItrService {
	...
	public void deleteUserRoleMappingAttachmentItr(long id, int isDelete) {
		repository.deleteUserRoleMappingAttachmentItr(id, isDelete, OAuthUtility.getCurrentUserUserId(), new java.util.Date());
	}
	...
	public PagebleDTO<EDPTrnUserMpAttItrDto> getUserRoleMappingAttachmentItrs(PageDetails pageDetail) throws CustomException {
		try {
			...
			SpecificationImpl<EDPTrnUserMpAttItrEntity> spec = new SpecificationImpl<>();
			pageable = pageDetail.getPageDetails(pageDetail);
			Specification<EDPTrnUserMpAttItrEntity> dataSpec = searchCriteria.getSpecificationDetails(spec,
					pageDetail.getJsonArr());
			Page<EDPTrnUserMpAttItrEntity> page = repository.findAll(dataSpec, pageable);
