...
public class AcpEmployeeDetailDto {
	...
	private String employeeClass; // deptClass
	...
	private String payScale; //payLevel

	@NativeQueryResultColumn(index = 15)
	private String payBandId; //empPaybandId

	@NativeQueryResultColumn(index = 16)
	private String payLevelId; //empPayLevel

	@NativeQueryResultColumn(index = 17)
	private String gradePayId; //empGradePay
	...
	private Long departmentCategoryId; // deptCategoryId

	@NativeQueryResultColumn(index = 28)
	private Long deptCategoryName; // deptCategoryName
	...
	private String acpEffDate;
	
	

	
	public String getAcpEffDate() {
		return acpEffDate;
	}

	public void setAcpEffDate(String acpEffDate) {
		this.acpEffDate = acpEffDate;
	}
	...
	/**
	 * @return the deptCategoryName
	 */
	public Long getDeptCategoryName() {
		return deptCategoryName;
	}

	/**
	 * @param deptCategoryName the deptCategoryName to set
	 */
	public void setDeptCategoryName(Long deptCategoryName) {
	 ...
	 * @return the isOldSuspended
	 */
	public Long getIsOldSuspended() {
		return isOldSuspended;
	}
