...
/**
 * The Class PVUPromotionAttDto.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class PVUPromotionAttDto extends BasePVUAttachmentDto {
    ...
    public PVUPromotionAttDto() {
        super();
    }

    public PVUPromotionAttDto(Long id) {
        super(id);
    }
    ...
    public boolean equals(Object obj) {
        ...
        PVUPromotionAttDto that = (PVUPromotionAttDto) obj;
