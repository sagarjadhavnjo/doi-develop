...
public class PromotionValidationRequest {
    ...
    public PromotionValidationRequest(@NotNull Long employeeId, @NotNull LocalDate effectiveDate, Long employeeClassId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PromotionValidationRequest)) return false;
        PromotionValidationRequest that = (PromotionValidationRequest) o;
    ...
    public String toString() {
        return new StringJoiner(", ", PromotionValidationRequest.class.getSimpleName() + "[", "]")
