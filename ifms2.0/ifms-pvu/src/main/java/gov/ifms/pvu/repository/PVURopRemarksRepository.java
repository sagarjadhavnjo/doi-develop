...
@Repository
@Transactional
public interface PVURopRemarksRepository
		extends JpaRepository<PVURopRemarksEntity, Long>, JpaSpecificationExecutor<PVURopRemarksEntity> {

	@Modifying(clearAutomatically = true)
	@Query(value = " UPDATE PVU.PVU_ROP_EVNT_REMARKS "
			+ " SET ACTIVE_STATUS = :activeStatus, UPDATED_BY = :updatedBy, "
			+ "	UPDATED_DATE = :updatedDate	WHERE RP_EVNT_ID = :trnId", nativeQuery = true)
