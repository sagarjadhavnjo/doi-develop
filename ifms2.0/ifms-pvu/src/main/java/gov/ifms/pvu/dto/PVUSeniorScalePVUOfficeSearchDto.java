...
/**
 * The Class PVUSeniorScalePVUOfficeSearchDto.
 */
@NativeQueryResultEntity
public class PVUSeniorScalePVUOfficeSearchDto implements Serializable {
	...
	private Date forwardDate;// inward fwd date
	...
	public String toString() {
		return "PVURevisionOfPaySearchView{" + "transNo='" + transNo + '\'' + ", employeeId=" + employeeId
				...
				+ ", createdDate=" + createdDate + ", isEditable=" + isEditable + ", empType='" + eventName + '\''
				+ ", trnStatus='" + empType + '\'' + ", wfStatus='" + wfStatus + '\'' + ", deleteFlag=" + deleteFlag
				+ ", printFlag=" + printFlag + ", approveDate=" + approveDate + ", authorizeDate=" + authorizeDate
				+ '}';
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PVUSeniorScalePVUOfficeSearchDto)) {
			return false;
		}
		PVUSeniorScalePVUOfficeSearchDto other = (PVUSeniorScalePVUOfficeSearchDto) obj;
