...
public class PVUSelectionGradOutwardView implements Serializable {
	...
	public String toString() {
		return "PVUSelectionGradOutwardView [recordCount=" + recordCount + ", outWardNo=" + outWardNo + ", outWardDate="
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PVUSelectionGradOutwardView)) {
			return false;
		}
		PVUSelectionGradOutwardView other = (PVUSelectionGradOutwardView) obj;
