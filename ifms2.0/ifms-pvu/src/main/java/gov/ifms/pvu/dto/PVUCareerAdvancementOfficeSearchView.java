...
public class PVUCareerAdvancementOfficeSearchView implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof PVUCareerAdvancementOfficeSearchView)) {
			return false;
		}
		PVUCareerAdvancementOfficeSearchView other = (PVUCareerAdvancementOfficeSearchView) obj;
	...
	public String toString() {
		return "PVUCareerAdvancementOfficeSearchView{" + "transNo='" + transNo + '\'' + ", employeeId=" + employeeId
				...
				+ ", empType='" + empType + '\'' + ", wfStatus='" + wfStatus + '\'' + ", deleteFlag=" + deleteFlag
				+ ", printFlag=" + printFlag + ", approveDate=" + approveDate + ", authorizeDate=" + authorizeDate
				+ ", forwardDate=" + forwardDate + ", inwardNo='" + inwardNo + '\'' + ", inwardDate=" + inwardDate
				+ ", inwardCount='" + inwardCount + '\'' + ", eventCode='" + eventCode + '\'' + '}';
	}
