 ...
 *
 */
public class WfConfigDto extends BaseDto implements Serializable {
	...
	public WfConfigDto(long createdBy, Date createdDate, long createdByPost, long updatedByPost, int activeStatus,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof WfConfigDto)) {
			return false;
		}
		WfConfigDto other = (WfConfigDto) obj;
