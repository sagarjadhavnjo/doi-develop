 ...
 */
@Entity
@Table(name="TDOI_COINS_POLICY_HDR_WF", schema = DoiJPAConstants.DOI_SCHEMA)
public class DoiCoinsPolicyHdrWfEntity extends BaseEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = 657174947297133259L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="COINS_POLICY_WF_ID", unique=true, nullable=false)
