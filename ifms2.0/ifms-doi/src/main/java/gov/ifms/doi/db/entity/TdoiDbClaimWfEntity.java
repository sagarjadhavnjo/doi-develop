...
/**
 * The persistent class for the TDOI_DB_CLAIM_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_CLAIM_WF", schema = DoiJPAConstants.DOI_SCHEMA)
public class TdoiDbClaimWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_CLAIM_WF_ID", unique = true, nullable = false)
	private long dbClaimWfId;
	...
	public TdoiDbClaimWfEntity() {
	}

	public long getDbClaimWfId() {
		return this.dbClaimWfId;
	}

	public void setDbClaimWfId(long dbClaimWfId) {
		this.dbClaimWfId = dbClaimWfId;
	}
