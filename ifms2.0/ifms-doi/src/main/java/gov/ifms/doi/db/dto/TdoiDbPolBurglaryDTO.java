...
public class TdoiDbPolBurglaryDTO extends BaseDto {
	...
	private List<TdoiDbPolBuglrRiDtlDTO> tdoiDbPolBuglrRiDtls;
	...
	private List<TdoiDbPolBurglaryWfDTO> tdoiDbPolBurglaryWfs;

	public TdoiDbPolBurglaryDTO() {
	}
	...
	public List<TdoiDbPolBuglrRiDtlDTO> getTdoiDbPolBuglrRiDtls() {
		return this.tdoiDbPolBuglrRiDtls;
	}

	public void setTdoiDbPolBuglrRiDtls(List<TdoiDbPolBuglrRiDtlDTO> tdoiDbPolBuglrRiDtls) {
		this.tdoiDbPolBuglrRiDtls = tdoiDbPolBuglrRiDtls;
	}

	public TdoiDbPolBuglrRiDtlDTO addTdoiDbPolBuglrRiDtl(TdoiDbPolBuglrRiDtlDTO tdoiDbPolBuglrRiDtl) {
	...
	public TdoiDbPolBuglrRiDtlDTO removeTdoiDbPolBuglrRiDtl(TdoiDbPolBuglrRiDtlDTO tdoiDbPolBuglrRiDtl) {
	...
	public List<TdoiDbPolBurglaryWfDTO> getTdoiDbPolBurglaryWfs() {
		return this.tdoiDbPolBurglaryWfs;
	}

	public void setTdoiDbPolBurglaryWfs(List<TdoiDbPolBurglaryWfDTO> tdoiDbPolBurglaryWfs) {
		this.tdoiDbPolBurglaryWfs = tdoiDbPolBurglaryWfs;
	}

	public TdoiDbPolBurglaryWfDTO addTdoiDbPolBurglaryWf(TdoiDbPolBurglaryWfDTO tdoiDbPolBurglaryWf) {
	...
	public TdoiDbPolBurglaryWfDTO removeTdoiDbPolBurglaryWf(TdoiDbPolBurglaryWfDTO tdoiDbPolBurglaryWf) {
