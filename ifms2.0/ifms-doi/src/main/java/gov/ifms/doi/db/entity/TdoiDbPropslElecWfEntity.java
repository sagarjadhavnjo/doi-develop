...
/**
 * The persistent class for the TDOI_DB_PROPSL_ELEC_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_PROPSL_ELEC_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropslElecWfEntity.findAll", query = "SELECT t FROM TdoiDbPropslElecWfEntity t")
public class TdoiDbPropslElecWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_PROP_ELEC_WF_ID", unique = true, nullable = false)
	private long dbPropElecWfId;
	...
	public TdoiDbPropslElecWfEntity() {
	}

	public long getDbPropElecWfId() {
		return this.dbPropElecWfId;
	}

	public void setDbPropElecWfId(long dbPropElecWfId) {
		this.dbPropElecWfId = dbPropElecWfId;
	}
