...
/**
 * The persistent class for the TDOI_HBA_PROPOSL_WF database table. * @author
 * Sagar Jadhav
 */
@Entity
@Table(name = "TDOI_HBA_PROPOSL_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiHbaProposlWfEntity.findAll", query = "SELECT t FROM TdoiHbaProposlWfEntity t")
public class TdoiHbaProposlWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "HBA_PROPOSL_WF_ID", unique = true, nullable = false)
	private long hbaProposlWfId;
	...
	/**
	 * @return the hbaProposlWfId
	 */
	public long getHbaProposlWfId() {
		return hbaProposlWfId;
	}

	/**
	 * @param hbaProposlWfId the hbaProposlWfId to set
	 */
	public void setHbaProposlWfId(long hbaProposlWfId) {
		this.hbaProposlWfId = hbaProposlWfId;
	}
