...
/**
 * The persistent class for the TDOI_DB_PROPSL_BURGLARY_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_PROPSL_BURGLARY_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropslBurglaryWfEntity.findAll", query = "SELECT t FROM TdoiDbPropslBurglaryWfEntity t")
public class TdoiDbPropslBurglaryWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_PROPSL_BURGL_WF_ID", unique = true, nullable = false)
	private long dbPropslBurglWfId;
	...
	public TdoiDbPropslBurglaryWfEntity() {
	}

	public long getDbPropslBurglWfId() {
		return this.dbPropslBurglWfId;
	}

	public void setDbPropslBurglWfId(long dbPropslBurglWfId) {
		this.dbPropslBurglWfId = dbPropslBurglWfId;
	}
