 ...
 */
@Entity
@Table(name = "TDOI_HBA_CLAIM_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiHbaClaimWfEntity.findAll", query = "SELECT t FROM TdoiHbaClaimWfEntity t")
public class TdoiHbaClaimWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "HBA_CLAIM_WF_ID", unique = true, nullable = false)
	...
	/**
	 * @param hbaClaimWfId the hbaClaimWfId to set
	 */
