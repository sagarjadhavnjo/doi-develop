...
/**
 * The persistent class for the TDOI_DB_POL_ELEC_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_POL_ELEC_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolElecWfEntity.findAll", query = "SELECT t FROM TdoiDbPolElecWfEntity t")
public class TdoiDbPolElecWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_POL_ELEC_WF_ID", unique = true, nullable = false)
	private long dbPolElecWfId;
	...
	private TdoiDbPolElecEquipEntity tdoiDbPolElecEquip;

	public TdoiDbPolElecWfEntity() {
	}

	public long getDbPolElecWfId() {
		return this.dbPolElecWfId;
	}

	public void setDbPolElecWfId(long dbPolElecWfId) {
		this.dbPolElecWfId = dbPolElecWfId;
	}
	...
	public TdoiDbPolElecEquipEntity getTdoiDbPolElecEquip() {
		return this.tdoiDbPolElecEquip;
	}

	public void setTdoiDbPolElecEquip(TdoiDbPolElecEquipEntity tdoiDbPolElecEquip) {
