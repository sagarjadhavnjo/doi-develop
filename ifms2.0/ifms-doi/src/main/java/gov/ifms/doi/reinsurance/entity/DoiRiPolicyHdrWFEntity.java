 ...
 */
@Entity
@Table(name="TDOI_RI_POLICY_HDR_WF", schema = DoiJPAConstants.DOI_SCHEMA)
public class DoiRiPolicyHdrWFEntity extends BaseEntity implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5103241679320602036L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="RI_POLICY_WF_ID", unique=true, nullable=false)
	private long riPolicyWfId;
	...
	//bi-directional many-to-one association to DoiRiPolicyHdrEntity
	@ManyToOne
	@JoinColumn(name="TRN_ID")
	private DoiRiPolicyHdrEntity doiRiPolicyHdrEntity;

	/**
	 * @return the riPolicyWfId
	 */
	public long getRiPolicyWfId() {
		return riPolicyWfId;
	}

	/**
	 * @param riPolicyWfId the riPolicyWfId to set
	 */
	public void setRiPolicyWfId(long riPolicyWfId) {
		this.riPolicyWfId = riPolicyWfId;
	}
