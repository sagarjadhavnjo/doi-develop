...
/**
 * The persistent class for the TDOI_DB_POL_BURGLARY database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_POL_BURGLARY", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolBurglaryEntity.findAll", query = "SELECT t FROM TdoiDbPolBurglaryEntity t")
public class TdoiDbPolBurglaryEntity extends BaseEntity {
	...
	// bi-directional many-to-one association to TdoiDbPolBuglrRiDtl
	@OneToMany(mappedBy = "tdoiDbPolBurglary")
	private List<TdoiDbPolBuglrRiDtlEntity> tdoiDbPolBuglrRiDtls;
	...
	// bi-directional many-to-one association to TdoiDbPolBurglaryWf
	@OneToMany(mappedBy = "tdoiDbPolBurglary")
	private List<TdoiDbPolBurglaryWfEntity> tdoiDbPolBurglaryWfs;

	public TdoiDbPolBurglaryEntity() {
	}
	...
	public List<TdoiDbPolBuglrRiDtlEntity> getTdoiDbPolBuglrRiDtls() {
		return this.tdoiDbPolBuglrRiDtls;
	}

	public void setTdoiDbPolBuglrRiDtls(List<TdoiDbPolBuglrRiDtlEntity> tdoiDbPolBuglrRiDtls) {
		this.tdoiDbPolBuglrRiDtls = tdoiDbPolBuglrRiDtls;
	}

	public TdoiDbPolBuglrRiDtlEntity addTdoiDbPolBuglrRiDtl(TdoiDbPolBuglrRiDtlEntity tdoiDbPolBuglrRiDtl) {
		getTdoiDbPolBuglrRiDtls().add(tdoiDbPolBuglrRiDtl);
		tdoiDbPolBuglrRiDtl.setTdoiDbPolBurglary(this);

		return tdoiDbPolBuglrRiDtl;
	}

	public TdoiDbPolBuglrRiDtlEntity removeTdoiDbPolBuglrRiDtl(TdoiDbPolBuglrRiDtlEntity tdoiDbPolBuglrRiDtl) {
		getTdoiDbPolBuglrRiDtls().remove(tdoiDbPolBuglrRiDtl);
		tdoiDbPolBuglrRiDtl.setTdoiDbPolBurglary(null);
	...
	public List<TdoiDbPolBurglaryWfEntity> getTdoiDbPolBurglaryWfs() {
		return this.tdoiDbPolBurglaryWfs;
	}

	public void setTdoiDbPolBurglaryWfs(List<TdoiDbPolBurglaryWfEntity> tdoiDbPolBurglaryWfs) {
		this.tdoiDbPolBurglaryWfs = tdoiDbPolBurglaryWfs;
	}

	public TdoiDbPolBurglaryWfEntity addTdoiDbPolBurglaryWf(TdoiDbPolBurglaryWfEntity tdoiDbPolBurglaryWf) {
		getTdoiDbPolBurglaryWfs().add(tdoiDbPolBurglaryWf);
		tdoiDbPolBurglaryWf.setTdoiDbPolBurglary(this);

		return tdoiDbPolBurglaryWf;
	}

	public TdoiDbPolBurglaryWfEntity removeTdoiDbPolBurglaryWf(TdoiDbPolBurglaryWfEntity tdoiDbPolBurglaryWf) {
		getTdoiDbPolBurglaryWfs().remove(tdoiDbPolBurglaryWf);
		tdoiDbPolBurglaryWf.setTdoiDbPolBurglary(null);
