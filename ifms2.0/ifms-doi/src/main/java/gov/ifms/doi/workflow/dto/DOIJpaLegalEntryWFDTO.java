 ...
 *
 */
public class DOIJpaLegalEntryWFDTO extends BaseDto {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6195106895789300029L;
	...
	private DOIJPALegalDetailEntryDTO doiJpaLegalEntry;
	...
	/**
	 * @return the legalEntryWfId
	 */
	public long getLegalEntryWfId() {
		return legalEntryWfId;
	}

	/**
	 * @param legalEntryWfId the legalEntryWfId to set
	 */
	public void setLegalEntryWfId(long legalEntryWfId) {
		this.legalEntryWfId = legalEntryWfId;
	}
	 ...
	 */
	public DOIJPALegalDetailEntryDTO getDoiJpaLegalEntry() {
	 ...
	 */
	public void setDoiJpaLegalEntry(DOIJPALegalDetailEntryDTO doiJpaLegalEntry) {
