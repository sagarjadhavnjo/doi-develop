package gov.ifms.doi.workflow.entity;
 ...
 */
@Entity
@Table(name="TDOI_COINS_CLAIM_HDR_WF", schema = DoiJPAConstants.DOI_SCHEMA)
public class DoiCoinsClaimHdrWfEntity extends BaseEntity {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5334196674878530575L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="COINS_CLAIM_WF_ID", unique=true, nullable=false)
