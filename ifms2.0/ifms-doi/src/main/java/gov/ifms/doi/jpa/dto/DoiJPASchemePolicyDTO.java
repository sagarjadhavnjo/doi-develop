...
public class DoiJPASchemePolicyDTO extends BaseDto {
	...
	// policy details
	private List<DoiJpaMasterPolicyDTO> policies;
	 ...
	 * @return the policies
	 */
	public List<DoiJpaMasterPolicyDTO> getPolicies() {
		return policies;
	}
	 ...
	 */
	public void setPolicies(List<DoiJpaMasterPolicyDTO> policies) {
