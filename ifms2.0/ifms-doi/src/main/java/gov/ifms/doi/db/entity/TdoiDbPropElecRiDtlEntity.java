 ...
 */
@Entity
@Table(name = "TDOI_DB_PROP_ELEC_RI_DTL", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropElecRiDtlEntity.findAll", query = "SELECT t FROM TdoiDbPropElecRiDtlEntity t")
public class TdoiDbPropElecRiDtlEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ELEC_RI_DTL_ID", unique = true, nullable = false)
	...
	public TdoiDbPropElecRiDtlEntity() {
	}
