 ...
 */
@Entity
@Table(name="TDOI_RI_PREMIUM_REGISTER", schema = DoiJPAConstants.DOI_SCHEMA)
public class DoiRiPremiumRegisterEntity extends BaseEntity implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7351342658640508452L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="RI_PREMIUM_ID", unique=true, nullable=false)
	...
	@Column(name="GIC_SHARE_AMT")
	private double gicShareAmt;

	@Column(name="GIC_SHARE_PC")
	...
	@Column(name="RI_PREM_AMT")
	private double riPremAmt;

	@Column(name="RI_PREM_PC")
