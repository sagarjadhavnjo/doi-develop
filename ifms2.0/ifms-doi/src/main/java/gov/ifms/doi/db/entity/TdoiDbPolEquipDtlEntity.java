 ...
 */
@Entity
@Table(name = "TDOI_DB_POL_EQUIP_DTLS", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolEquipDtlEntity.findAll", query = "SELECT t FROM TdoiDbPolEquipDtlEntity t")
public class TdoiDbPolEquipDtlEntity extends BaseEntity {
	...
	public TdoiDbPolEquipDtlEntity() {
	}
