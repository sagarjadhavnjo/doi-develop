...
/**
 * The persistent class for the TDOI_SURVEYOR_BILL_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_SURVEYOR_BILL_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiSurveyorBillWfEntity.findAll", query = "SELECT t FROM TdoiSurveyorBillWfEntity t")
public class TdoiSurveyorBillWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "SURVEYOR_BILL_WF_ID", unique = true, nullable = false)
	private long surveyorBillWfId;
	...
	@JsonBackReference
	private TdoiSurveyorBillDtlEntity tdoiSurveyorBillDtl;

	/**
	 * @return the surveyorBillWfId
	 */
	public long getSurveyorBillWfId() {
		return surveyorBillWfId;
	}

	/**
	 * @param surveyorBillWfId the surveyorBillWfId to set
	 */
	public void setSurveyorBillWfId(long surveyorBillWfId) {
		this.surveyorBillWfId = surveyorBillWfId;
	}
	...
	/**
	 * @return the tdoiSurveyorBillDtl
	 */
	public TdoiSurveyorBillDtlEntity getTdoiSurveyorBillDtl() {
		return tdoiSurveyorBillDtl;
	}

	/**
	 * @param tdoiSurveyorBillDtl the tdoiSurveyorBillDtl to set
	 */
	public void setTdoiSurveyorBillDtl(TdoiSurveyorBillDtlEntity tdoiSurveyorBillDtl) {
		this.tdoiSurveyorBillDtl = tdoiSurveyorBillDtl;
	}
