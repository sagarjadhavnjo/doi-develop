 ...
 */
@Entity
@Table(name="TDOI_JPA_CLAIM_WF", schema = DoiJPAConstants.DOI_SCHEMA)
public class DoiJpaClaimEntryWF extends BaseEntity {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -7994890856709738729L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="JPA_CLAIM_WF_ID")
	private long jpaClaimWfId;
	...
	/**
	 * @return the jpaClaimWfId
	 */
	public long getJpaClaimWfId() {
		return jpaClaimWfId;
	}

	/**
	 * @param jpaClaimWfId the jpaClaimWfId to set
	 */
	public void setJpaClaimWfId(long jpaClaimWfId) {
		this.jpaClaimWfId = jpaClaimWfId;
	}
