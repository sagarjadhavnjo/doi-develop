 ...
 */
@Entity
@Table(name="TDOI_JPA_LEGAL_ENTRY_WF", schema = DoiJPAConstants.DOI_SCHEMA)
public class DOIJpaLegalEntryWFEntity extends BaseEntity {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5618893815512297368L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="LEGAL_ENTRY_WF_ID", unique=true, nullable=false)
