...
/**
 * The persistent class for the TDOI_DB_POL_BURGLARY_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_POL_BURGLARY_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolBurglaryWfEntity.findAll", query = "SELECT t FROM TdoiDbPolBurglaryWfEntity t")
public class TdoiDbPolBurglaryWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_POL_BURGL_WF_ID", unique = true, nullable = false)
	private long dbPolBurglWfId;
	...
	private TdoiDbPolBurglaryEntity tdoiDbPolBurglary;

	public TdoiDbPolBurglaryWfEntity() {
	}

	public long getDbPolBurglWfId() {
		return this.dbPolBurglWfId;
	}

	public void setDbPolBurglWfId(long dbPolBurglWfId) {
		this.dbPolBurglWfId = dbPolBurglWfId;
	}
	...
	public TdoiDbPolBurglaryEntity getTdoiDbPolBurglary() {
		return this.tdoiDbPolBurglary;
	}

	public void setTdoiDbPolBurglary(TdoiDbPolBurglaryEntity tdoiDbPolBurglary) {
