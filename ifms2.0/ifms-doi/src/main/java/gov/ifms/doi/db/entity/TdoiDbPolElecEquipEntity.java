 ...
 */
@Entity
@Table(name = "TDOI_DB_POL_ELEC_EQUIP", schema = DoiJPAConstants.DOI_SCHEMA)
public class TdoiDbPolElecEquipEntity extends BaseEntity {
	...
	// bi-directional many-to-one association to TdoiDbPolElecWf
	@OneToMany(mappedBy = "tdoiDbPolElecEquip")
	private List<TdoiDbPolElecWfEntity> tdoiDbPolElecWfs;

	// bi-directional many-to-one association to TdoiDbPolEquipDtl
	@OneToMany(mappedBy = "tdoiDbPolElecEquip")
	private List<TdoiDbPolEquipDtlEntity> tdoiDbPolEquipDtls;

	public TdoiDbPolElecEquipEntity() {
	}
	...
	public List<TdoiDbPolElecWfEntity> getTdoiDbPolElecWfs() {
		return this.tdoiDbPolElecWfs;
	}

	public void setTdoiDbPolElecWfs(List<TdoiDbPolElecWfEntity> tdoiDbPolElecWfs) {
		this.tdoiDbPolElecWfs = tdoiDbPolElecWfs;
	}

	public TdoiDbPolElecWfEntity addTdoiDbPolElecWf(TdoiDbPolElecWfEntity tdoiDbPolElecWf) {
		getTdoiDbPolElecWfs().add(tdoiDbPolElecWf);
		tdoiDbPolElecWf.setTdoiDbPolElecEquip(this);

		return tdoiDbPolElecWf;
	}

	public TdoiDbPolElecWfEntity removeTdoiDbPolElecWf(TdoiDbPolElecWfEntity tdoiDbPolElecWf) {
		getTdoiDbPolElecWfs().remove(tdoiDbPolElecWf);
		tdoiDbPolElecWf.setTdoiDbPolElecEquip(null);

		return tdoiDbPolElecWf;
	}

	public List<TdoiDbPolEquipDtlEntity> getTdoiDbPolEquipDtls() {
		return this.tdoiDbPolEquipDtls;
	}

	public void setTdoiDbPolEquipDtls(List<TdoiDbPolEquipDtlEntity> tdoiDbPolEquipDtls) {
		this.tdoiDbPolEquipDtls = tdoiDbPolEquipDtls;
	}

	public TdoiDbPolEquipDtlEntity addTdoiDbPolEquipDtl(TdoiDbPolEquipDtlEntity tdoiDbPolEquipDtl) {
		getTdoiDbPolEquipDtls().add(tdoiDbPolEquipDtl);
		tdoiDbPolEquipDtl.setTdoiDbPolElecEquip(this);

		return tdoiDbPolEquipDtl;
	}

	public TdoiDbPolEquipDtlEntity removeTdoiDbPolEquipDtl(TdoiDbPolEquipDtlEntity tdoiDbPolEquipDtl) {
		getTdoiDbPolEquipDtls().remove(tdoiDbPolEquipDtl);
		tdoiDbPolEquipDtl.setTdoiDbPolElecEquip(null);
