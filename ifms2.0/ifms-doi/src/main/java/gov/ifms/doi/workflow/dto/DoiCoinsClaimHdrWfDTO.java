 ...
 *
 */
public class DoiCoinsClaimHdrWfDTO extends BaseDto {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4241586575064444981L;

	private long coinsClaimWfId;
	...
	private DoiCoinsClaimHdrDTO doiCoinsClaimHdr;
	
	private long coinsClaimId;

	/**
	 * @return the coinsClaimWfId
	 */
	public long getCoinsClaimWfId() {
		return coinsClaimWfId;
	}

	/**
	 * @param coinsClaimWfId the coinsClaimWfId to set
	 */
	public void setCoinsClaimWfId(long coinsClaimWfId) {
		this.coinsClaimWfId = coinsClaimWfId;
	}
	...
	/**
	 * @return the doiCoinsClaimHdr
	 */
	public DoiCoinsClaimHdrDTO getDoiCoinsClaimHdr() {
		return doiCoinsClaimHdr;
	}

	/**
	 * @param doiCoinsClaimHdr the doiCoinsClaimHdr to set
	 */
	public void setDoiCoinsClaimHdr(DoiCoinsClaimHdrDTO doiCoinsClaimHdr) {
		this.doiCoinsClaimHdr = doiCoinsClaimHdr;
	}
