 ...
 */
@Entity
@Table(name = "TDOI_DB_POL_BUGLR_RI_DTL", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolBuglrRiDtlEntity.findAll", query = "SELECT t FROM TdoiDbPolBuglrRiDtlEntity t")
public class TdoiDbPolBuglrRiDtlEntity extends BaseEntity {
	...
	public TdoiDbPolBuglrRiDtlEntity() {
	}
