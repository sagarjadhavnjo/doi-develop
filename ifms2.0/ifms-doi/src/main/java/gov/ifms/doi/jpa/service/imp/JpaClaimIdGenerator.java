...
public class JpaClaimIdGenerator extends SequenceStyleGenerator {
    ...
    public void configure(Type type, Properties params,
        ...
        this.format = "DOI/JPA/48/P/"+dateFormat+"-"+dateFormat.substring(2)+dateNumberSeparator+numberFormat; 
    } 
