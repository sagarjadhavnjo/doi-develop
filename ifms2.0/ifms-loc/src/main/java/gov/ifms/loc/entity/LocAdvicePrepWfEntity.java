...
/**
 * The Class LocAdvicePrepWfEntity.
 */
@Entity
@Table(name = "TLOC_ADVC_PREP_WF", schema = LocConstant.LOC_SCHEMA)
public class LocAdvicePrepWfEntity extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LocAdvicePrepWfEntity)) {
            return false;
        }

        LocAdvicePrepWfEntity other = (LocAdvicePrepWfEntity) obj;
