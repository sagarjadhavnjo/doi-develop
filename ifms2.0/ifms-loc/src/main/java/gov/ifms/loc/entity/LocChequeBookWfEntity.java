 ...
 */
@Entity
@Table(name = "TLOC_LC_CHEQUEBOOK_WF", schema = LocConstant.LOC_SCHEMA)
public class LocChequeBookWfEntity extends BaseEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof LocChequeBookWfEntity)) {
			return false;
		}

		LocChequeBookWfEntity other = (LocChequeBookWfEntity) obj;
