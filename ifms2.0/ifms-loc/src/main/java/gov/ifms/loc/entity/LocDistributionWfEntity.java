...
/**
 * The Class LocDistibutionWfEntity.
 *
 * @version 1.0
 * @created 2020/09/09 09:21:24
 */
@Entity
@Table(name = "TLOC_DISTRIBUTION_WF", schema = LocConstant.LOC_SCHEMA)
public class LocDistributionWfEntity extends BaseEntity implements Serializable {
     ...
     */
    public LocDistributionWfEntity() {
        super();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LocDistributionWfEntity)) {
            return false;
        }

        LocDistributionWfEntity other = (LocDistributionWfEntity) obj;
