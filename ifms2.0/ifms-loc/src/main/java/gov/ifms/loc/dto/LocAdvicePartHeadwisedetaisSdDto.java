 ...
 *
 */
public class LocAdvicePartHeadwisedetaisSdDto extends BaseDto implements Serializable {
	 ...
	 */
	public LocAdvicePartHeadwisedetaisSdDto() {
		super();
	}
