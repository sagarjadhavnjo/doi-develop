 ...
 */
@Entity
@Table(name = "TLOC_LC_ADVICE_HEADWISE_SD", schema = LocConstant.LOC_SCHEMA)
public class LocAdviceHeadwiseSdEntity extends BaseEntity implements Serializable {
     ...
     */
    public LocAdviceHeadwiseSdEntity() {
        super();
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getId(), getFundType(), getChargedVoted(), getBudgetType(), getEstimateType(), getSchemeNo(), getExpensitureAmt(), getAvailableAmt(), getLcNo(), getDemandId(), getMajoreheadId(), getSubmajorheadId(), getMinorheadId(), getSubheadId(), getDetailheadId(), getItemId(), getObjectclassId(), getLcAdviceId());
    }
}
