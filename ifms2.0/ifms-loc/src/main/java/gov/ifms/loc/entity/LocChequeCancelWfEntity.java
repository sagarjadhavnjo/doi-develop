 ...
 */
@Entity
@Table(name = "TLOC_CHEQUE_CANCEL_WF", schema = LocConstant.LOC_SCHEMA)
public class LocChequeCancelWfEntity extends BaseEntity implements Serializable {
    ...
    @JoinColumn(name = "TRN_ID", nullable = false, referencedColumnName = "CHEQUE_CANCELLATION_ID")
    private LocChequeCancelHdrEntity trnId;
    ...
    /**
     * LocChequeCancelWfEntity Constructor.
     */
    public LocChequeCancelWfEntity() {
        super();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof LocChequeCancelWfEntity)) {
            return false;
        }

        LocChequeCancelWfEntity other = (LocChequeCancelWfEntity) obj;
     ...
     * @return the trn id
     */
    public LocChequeCancelHdrEntity getTrnId() {
        return trnId;
    }
     ...
     */
    public void setTrnId(LocChequeCancelHdrEntity trnId) {
        this.trnId = trnId;
    }
